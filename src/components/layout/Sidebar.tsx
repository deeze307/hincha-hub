...
import { Home, Trophy, TrendingUp, Settings, Star, X, Mail, Bell, HelpCircle } from 'lucide-react'
...
const NAV = [
  ...
  { to: '/ayuda',        icon: HelpCircle, label: 'Ayuda',         adminOnly: false, comingSoon: false },
